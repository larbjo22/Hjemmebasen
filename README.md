...
```
index.html        Offentlig forside – appene, bli-med-flyt og kontaktskjema
hjem.html         Dashbord/launcher – status per aktiv app, responsiv (mobil + PC)
om.html           Videresending til forsiden (gamle lenker)
